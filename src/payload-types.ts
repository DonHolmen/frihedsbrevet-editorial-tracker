...
export interface ContentItem {
  ...
  /**
   * Contributors can only see/edit items where they are an author.
   */
  authors: (number | User)[];
  deadline?: string | null;
  /**
   * Body copy. Concurrent-edit safe via Payload document locking (see §3).
   */
  content?: {
    root: {
      type: string;
  ...
  /**
   * Archived items drop out of the editorial pipeline.
   */
